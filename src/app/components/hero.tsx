      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 pt-8 lg:pt-16">
          ...
          >
            <div className="relative w-12 h-12">
              <svg viewBox="0 0 100 100" className="w-full h-full">
                ...
                />
                <path
                  d="M40 40 L60 40 L70 60 L50 70 L30 60 Z"
                  fill="#FFFFFF"
                  stroke="#4D94FF"
                  strokeWidth="1"
                />
          ...
          <div className="w-full lg:w-2/3 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            >
              Discover the best AI Models in One Place - Your gateway to 50+
              leading AI assistants, all unified in a seamless experience.
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Experience the future of AI interaction with our unified platform
              that brings together the best AI models in one place.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Browse and select from our extensive library of 50+ leading AI models.",
                icon: (
              ...
              },
              {
                ...
                description:
                  "Chat, create, and collaborate with your chosen AI through our intuitive interface.",
                icon: (
              ...
              },
              {
                ...
                description:
                  "Access all AI models with a single subscription - no more juggling multiple accounts.",
                icon: (
